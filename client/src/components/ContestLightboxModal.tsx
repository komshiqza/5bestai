...
import { X, Heart, User, Calendar, Share2, Sparkles } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row h-full" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="w-full lg:w-[400px] xl:w-[480px] bg-white dark:bg-slate-900 overflow-y-auto">
            {/* Header with Close Button */}
            <div className="sticky top-0 bg-white dark:bg-slate-900 border-b border-slate-300/60 dark:border-slate-700/60 p-4 flex items-center justify-between z-10">
              <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200" data-testid="text-submission-title">
                {submission.title}
              </h2>
              <button
                onClick={onClose}
            ...
            <div className="p-4 space-y-6">
              ...
              {submission.user && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-800 dark:text-slate-200" data-testid="text-creator-username">
              ...
              {submission.description && !showPromptSection && (
                <div>
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-300" data-testid="text-submission-description">
              ...
              {/* AI Tool Info */}
              {submission.aiTool && (
                <div className="p-3 rounded-lg bg-violet-50/50 dark:bg-violet-950/20 border border-violet-300/60 dark:border-violet-700/60">
                ...
                <div className="space-y-3">
                  ...
                  {needsPurchase && user && submission.promptPrice && submission.promptCurrency && (
                    <button
                      ...
                      className="w-full py-3 px-4 rounded-lg font-semibold bg-violet-600 text-white hover:bg-violet-700 transition-all flex items-center justify-center gap-2"
              ...
              {/* Metadata */}
              <div className="pt-4 border-t border-slate-300/60 dark:border-slate-700/60 flex items-center justify-between text-sm text-slate-600 dark:text-slate-400">
                <div className="flex items-center gap-2">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleShare}
                  className="flex-1 py-3 px-4 rounded-lg font-semibold bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all flex items-center justify-center gap-2"
